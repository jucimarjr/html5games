...
Rules.prototype = {
    initStateMachine: function (stateMachine) {
        ...
        stateMachine.addTransition(States.WAIT_MORE_PLAYERS, Events.BACK_CLICKED, States.WAIT_MORE_PLAYERS, [this.actions.requestExitRoom.bind(this.actions)]);
        stateMachine.addTransition(States.WAIT_MORE_PLAYERS, Events.SERVER_ACK_EXIT_ROOM, States.ROOMS, [this.actions.showRoomsPage.bind(this.actions)]);
        stateMachine.addTransition(States.WAIT_MORE_PLAYERS, Events.ROOMS_INFO_RECEIVED, States.WAIT_MORE_PLAYERS, [this.actions.updatePlayers.bind(this.actions)]);
    }
};