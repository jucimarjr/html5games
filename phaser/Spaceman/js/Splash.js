Splash = function (game) {
    this.game = game;
    this.groupSplashImage = 'assets/screens/LudusSplash.png';
    this.gameSplashImage = 'assets/screens/menu.png';
};
...
Splash.prototype.create = function() {
	...
	setTimeout(function() {
		...
		fadeout.onComplete.add(function() {
			...
			var fadein = game.add.tween(fundo).to( { alpha: 1 }, 500, Phaser.Easing.Linear.None, true, 0, 0, true);
			setTimeout(function() {
				var fadeout = game.add.tween(fundo).to( { alpha: 1 }, 500, Phaser.Easing.Linear.None, true, 0, 0, true);
				fadeout.onComplete.add(function(){
